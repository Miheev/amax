			...
			if ($arItem["MODULE_ID"] == 'iblock'):
				...
				if ($i = $img->Fetch()):
                    echo '<table width=100% cellpadding=0 cellspacing="0" border="0">
                        <tr>
                            <td width=150 style="padding-right:10px;" align="center">
                                <img src="/upload/'.$i["SUBDIR"].'/'.$i["FILE_NAME"].'" width="'.$i["WIDTH"].'" height="'.$i["HEIGHT"].'"></td>
                            <td valign="top">';
				else:
					echo '<table width=100% cellpadding=0 cellspacing="0" border="0">
                        <tr>
...
//				echo '<table width=100% cellpadding=0 cellspacing="0" border="0"><tr><td width=150 style="padding-right:10px;" valign="top"><img src="/'.$img["SUBDIR"].'/'.$img["FILENAME"].'" width="'.$img["WIDTH"].'" height="'.$img["HEIGHT"].'"></td><td valign="top">';
				?>
                <strong><a href="<?=$URL?>"><?echo $arItem["TITLE_FORMATED"]?></a></strong>
...
//				echo '<img src="'.$img["
		...
		?>
		<strong><a href="<?echo $arItem["URL"]?>"><?echo $arItem["TITLE_FORMATED"]?></a></strong>
		<p><?echo $arItem["BODY_FORMATED"]?></p>
		<?if (
