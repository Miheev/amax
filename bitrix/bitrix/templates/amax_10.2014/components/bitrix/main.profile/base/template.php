...
<div class="profile vblock" id="user_div_reg">
...
<?endif?>
    ...
    <?endif;?>
	<?// ******************** /User properties ***************************************************?>
    <div class="policy vblock">
        <p><?echo $arResult["GROUP_POLICY"]["PASSWORD_REQUIREMENTS"];?></p>
    </div>
    <div class="buttons vblock">
        <input class="abutton" type="submit" name="save" value="<?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?>">
        <input class="abutton" type="reset" value="<?=GetMessage('MAIN_RESET');?>">
    </div>
</form>
</div>