    ...
    <table class="content clearfix">
        <thead>
            <tr>
                ...
                <th>Наименование</th>
                <th>Цена</th>
<!--                --><?//if (!empty($arItem['DISPLAY_PROPERTIES']['DTIME']['DISPLAY_VALUE'])):?>
                    <th>Срок доставки</th>
<!--                --><?//endif;?>
                <th>&nbsp;</th>
            </tr>
    ...
    <?foreach ($arResult['ITEMS'] as $key => $arItem) {
        ...
        <tr id="<? echo $strMainID; ?>">
            <td><?=$arItem['DISPLAY_PROPERTIES']['BRAND']['DISPLAY_VALUE'];?></td>
            <td><?echo empty($arItem['DISPLAY_PROPERTIES']['NUM']['DISPLAY_VALUE']) ? $arItem['DISPLAY_PROPERTIES']['OEM']['DISPLAY_VALUE'] : $arItem['DISPLAY_PROPERTIES']['NUM']['DISPLAY_VALUE'];?></td>
...
<!--            --><?//if (!empty($arItem['DISPLAY_PROPERTIES']['DTIME']['DISPLAY_VALUE'])):?>
                <td><?=$arItem['DISPLAY_PROPERTIES']['DTIME']['DISPLAY_VALUE'];?></td>
<!--            --><?//endif;?>
            <td><a class="abutton gradient" href="<?=$arItem['BUY_URL'];?>">купить</a></td>
        </tr>
  <?}?>
        </tbody>
    </table>
