...
<?$APPLICATION->IncludeComponent("bitrix:news.list", "news_related", array(
    ...
    <p class="all-news"><a href="<?=$arResult["FOLDER"].$arResult["URL_TEMPLATES"]["news"]?>"><?=GetMessage("T_NEWS_DETAIL_BACK")?></a></p>
