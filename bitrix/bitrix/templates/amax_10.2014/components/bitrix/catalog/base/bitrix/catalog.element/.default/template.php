...
<div class="bx_item_slider clearfix" id="<? echo $arItemIDs['BIG_SLIDER_ID']; ?>">
	...
	<div class="bx_bigimages_imgcontainer clearfix">
...
?>
		...
		<div class="bx_rt">
        <div class="main-stuff-info">
        <div class="shadow">
            <img src="<?=SITE_TEMPLATE_PATH?>/img/bk_stuff_info.png" alt="" />
        </div>
...
?>
	<div class="item_buttons vam">
        ...
        <div class="buttons">
            <span class="buy-btn product-btn">
			    <a href="javascript:void(0);" id="<? echo $arItemIDs['BUY_LINK']; ?>">Купить сейчас</a>
		    </span>
            <span class="cart-btn product-btn">
                <a href="<?=$arResult['ADD_URL']?>">В корзину</a>
            </span>
...
?>
        ...
        <div class="prod-description">
            ...
            <div class="left">
                <img src="<?=SITE_TEMPLATE_PATH?>/img/deliver_self.png" alt="" />
                <span>Самовывоз</span>
            </div>
            <div class="right">
